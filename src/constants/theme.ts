...
export const ASSETS: ThemeAssets = {
  // fonts
  OpenSansLight: require('../assets/fonts/Poppins-Regular.ttf'),
  OpenSansRegular: require('../assets/fonts/Poppins-Regular.ttf'),
  OpenSansSemiBold: require('../assets/fonts/Poppins-SemiBold.ttf'),
  OpenSansExtraBold: require('../assets/fonts/Poppins-SemiBold.ttf'),
  OpenSansBold: require('../assets/fonts/Poppins-SemiBold.ttf'),
