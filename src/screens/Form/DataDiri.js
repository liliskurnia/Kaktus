...
export default function DataDiri({ route }) {
    ...
    const { jumlahKeluarga } = route.params;
        ...
        <Block flex={1} style={{ backgroundColor: '#071952' }}>
            ...
            <View style={{ backgroundColor: '#EEEEEE', height: '100%', borderRadius: 30 }}>
                <Block
                    ...
                    {Array.from({ length: jumlahKeluarga }, (_, index) => (
                        <View key={index}>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 80, marginTop: 50, borderRadius: 30 }}>
