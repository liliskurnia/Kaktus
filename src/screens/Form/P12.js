            ...
            <View style={{ backgroundColor: '#EEEEEE', height: '100%', borderRadius: 30}}>
                <Block
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                        ...
                        <Text style={{fontWeight:'bold', color:'black', fontSize:18}}>1.2</Text>
                    </View>
                    <View
                        style={{
                            marginVertical: 10,
                    ...
                    {balita === 'first' && (
                        <View>
                            <View style={{ flexDirection: 'row' }}>
                                ...
                                />
                                <Text style={{  marginTop: 10, fontSize:16  }}>24 - 35 bulan </Text>
                            </View>
                            <View style={{ flexDirection: 'row' }}>
                                <RadioButton
                                    value="second"
                                ...
                                />
                                <Text style={{  marginTop: 10, fontSize:16  }}>36 - 59 bulan</Text>
                            </View>
                        </View>
                    )}
                    <View style={{ backgroundColor: '#EEEEEE', padding: 10, marginTop: 20 }}>
