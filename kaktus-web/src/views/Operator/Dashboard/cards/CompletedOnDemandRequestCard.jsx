...
const CompletedOnDemandRequestCard = ({ isLoading }) => {
...
CompletedOnDemandRequestCard.propTypes = {
  isLoading: PropTypes.bool
};

export default CompletedOnDemandRequestCard;
